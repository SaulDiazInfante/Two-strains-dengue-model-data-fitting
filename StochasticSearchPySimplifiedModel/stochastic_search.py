...
class StochasticSearch():
    ...
    def f_rhs(self, x, t, Lambda_M, beta_M, beta_H, b, mu_M,
        ...
        A_I1 = c_M * I_1
        A_I2 = c_M * I_2
        A_Ym1 = c_M * (Y_m1_c + Y_m1_h)
        B_M1 = c_H * M_I1
        B_M2 = c_H * M_I2
        theta = self.theta

        # rhs of the ODE model
        dM_s = Lambda_M - (A_I1 + A_I2 + A_Ym1) * M_s - mu_M * M_s
        ...
        #
        dY_m1_c = (1.0 - theta) * sigma * B_M2 * S_m1 - alpha_c * Y_m1_c
        dY_m1_h = theta * sigma * B_M2 * S_m1 - alpha_h * Y_m1_h
        #
        dR = alpha_c * (I_1 + I_2 + Y_m1_c) + alpha_h * Y_m1_h
        dz = p * (dI_1 + dI_2 + dY_m1_c)
        dydt = np.array([dM_s, dM_I1, dM_I2,
                         dI_s, dI_1, dI_2,
                         dS_m1, dY_m1_c, dR, dz, dY_m1_h])
    ...
    def solution_plot(self):
        ...
        #
        t = self.t
        N_H = I_s + I_1 + I_2 + S_m1 + Y_m1_c + Y_m1_h + recovers
        #
    ...
    def parameters_sampling_per_week(self, flag_deterministic=False):
        ...
        if flag_deterministic:
            ...
            #
            Y_m1_h_0 = 0.0025 * self.N_H
            Y_m1_c_0 = 0.0025 * self.N_H
            Rec_0 = 0.0
            z0 = p * (I_10 + I_20 + Y_m1_c_0)
        ...
        self.S_m1_0 = S_m1_0
        #
        self.Y_m1_c_0 = Y_m1_c_0
        self.Y_m1_h_0 = Y_m1_h_0
        ...
        new_parameters = [Lambda_M, beta_M,
                          ...
                          S_m1_0, Y_m1_c_0, Y_m1_h_0, Rec_0, z0, h, T]
        new_parameters = np.array(new_parameters)
        return new_parameters
    #
    ...
    def ode_int_solution_per_week(self):
        ...
        y_0 = np.array(
            [self.M_s0, self.M_10, self.M_20,
             self.I_s0, self.I_10, self.I_20,
             self.S_m1_0, self.Y_m1_c_0,
             self.Rec_0, self.z0, self.theta * self.Y_m1_h_0])
        Lambda_M = self.Lambda_M
        beta_M = self.beta_M
        beta_H = self.beta_H
        b = self.b
